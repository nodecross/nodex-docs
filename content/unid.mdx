...
The UNiD Core has fundermental capabilities of decentralized identifiers and verifiable credentials technologies. enables end-users to onboard seamlessly and bring the security advantage and 
...
The UNiD Extensions and SDKs offer convenient and easy-to-access application logic to build applications and integrate with digital services that exist out of our platform. The required authentication/authorization and credential data model are strongly dependent on use cases which are outside scope of UNiD Core and Drivers.
