...
In the simplest case, service providers can authenticate with users without the need for a usename or password. The benefits for users is that they no longer have to manage passwords, and they can securely and easy to access services. Service providers can eliminate the need to hold personal information in "honeypot" for bad actors, which has become a liability in a recent years.
...
![DID Ecosystem Overview](../../assets/didecosystemoverview.svg)
