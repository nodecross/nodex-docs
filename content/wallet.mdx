...
On this section, we introduce UNiD SDKs for building a wallet which provides storage of cryptographic keys and secrets with mobile devices as an agent. At the moment, we support React Native SDKs.

### React Native

UNiD React Native SDKs offer easy-to-use javascript module for DID operations, VC operations, and DID communications through the underlying UNiD Core APIs and Drivers.

Here, we get you up and running with React Native SDKs for embedding wallet capabilities into mobile application.
