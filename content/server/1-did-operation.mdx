...
With the Node SDK, you can easily generate a master seed and key pairs using SECP256K1 with ECDSA algorithm and the payload required for DID register operation.

```js
import { UNiD, KeyRingType } from "@unid/node-unid-server-sdk";
