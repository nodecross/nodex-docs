...
With the Node SDK, you can easily generate key pairs using SECP256K1 with ECDSA algorithm and the payload required for DID register operation at RP's server side.
