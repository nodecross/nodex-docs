...
After generating a master seed, it can display the seed phrases for validation. Once the user validates the seed phrases, they cannot be displayed again.
...
try{
    var result = DID.verifySeedPhrase(seed_phrases);
