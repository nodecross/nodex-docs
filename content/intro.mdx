...
In many parts of the world, the rapid acceleration of digital transformation by COVID-19 has brought to light a number of issues related to **digital trust**.
As a simple example, as a result of promoting DX of administrative services, there were many cases where services became rather troublesome.
...
At [UNiD Platform](./unid), we are focused on building tools that enable **digital trust** on common standards for security, privacy, and transparency in order to take the next phase of trust.
As a central part of the transition, it's important first step to establish a globally unique identity that can be controlled directly by a user without the need for centralized authorities or trusted third parties.
