...
Our society has been established by reducing that complexity with trust.
...
For example, there are many cases in which the administrative procedures become rather cumbersome due to the complexity of digital identity verification process.
...
In order to scale trust to the global demand of digital system and the Internet,
we are focused on building tools that enable ***digital trust*** on common standards for privacy and security.
...
[UNiD Platform](./unid) provides fundermental capabilities of operating DIDs, verifiable credential interactions around DIDs in a privacy-preserving manner.
