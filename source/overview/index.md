...
UNiD EDGE is provided as an [open-source](https://github.com/getunid/unid), while UNiD HUB and Studio are provided as a proprietary software and hosted in a cloud environment.
By embedding UNiD EDGE in devices, developers can establish end-to-end authentication channels with UNiD HUB, and enable secure bi-directional communications between devices and the cloud simply.

:::{figure-md}

<img src="../_assets/figure1.svg" alt="figure1" width="350px">
...
<img src="../_assets/figure2.svg" alt="figure2">
